...
function init() {
    ...
    loader.load( './objects/slotted_disk.stl', function ( geometry ) {
    ...
    loader.load( './objects/pr2_head_pan.stl', function ( geometry ) {
    ...
    // Colored binary STL
    loader.load( './objects/colored.stl', function ( geometry ) {
